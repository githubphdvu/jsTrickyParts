...
describe("createAccount", function() {
  ...
  describe("deposit", function() {
    ...
    it("adds the amount to the account balance", function() {
      expect(account.deposit("1234", 100)).toBe("Succesfully deposited $100. Current balance: $100.")
      expect(account.deposit("1234", 200)).toBe("Succesfully deposited $200. Current balance: $300.")
